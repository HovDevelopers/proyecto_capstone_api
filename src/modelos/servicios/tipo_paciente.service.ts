...
export class TipoPacienteService {
    ...
    async crearTipoPaciente(nombreTipoPaciente: crearNombreCodigo){
    ...
    async actualizar(id: number, actualizarTipoPaciente: actualizarNombreCodigo): Promise<TipoPaciente> {
